...
public class PetCaptureFailureEvent extends PetCaptureEvent {

    public static final HandlerList HANDLER_LIST = new HandlerList();

    public PetCaptureFailureEvent(@NotNull Player player, @NotNull LivingEntity entity, @NotNull Template template, @NotNull Tier tier) {
