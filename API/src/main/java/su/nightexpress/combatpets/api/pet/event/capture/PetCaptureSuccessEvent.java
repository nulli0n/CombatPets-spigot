...
public class PetCaptureSuccessEvent extends PetCaptureEvent {

    public static final HandlerList HANDLER_LIST = new HandlerList();

    public PetCaptureSuccessEvent(@NotNull Player player, @NotNull LivingEntity entity, @NotNull Template template, @NotNull Tier tier) {
