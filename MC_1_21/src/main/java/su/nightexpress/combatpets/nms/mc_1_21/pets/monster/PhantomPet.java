...
public class PhantomPet extends Phantom implements PetEntity {
    ...
    abstract class PhantomMoveTargetGoal extends Goal {
        ...
        protected boolean touchingTarget() {
            Vec3 moveTargetPoint = (Vec3) Reflex.getFieldValue(PhantomPet.this, "e"); // moveTargetPoint
        ...
        protected Object getAttackPhase() {
            return Reflex.getFieldValue(PhantomPet.this, "cc"); // attack phase
            // 0 - CIRCLE
            // 1 - SWOOP
        }

        protected void setAttackPhase(int i) {
            Reflex.setFieldValue(PhantomPet.this, "cc", phaseValues[i]);
        }
    }
    ...
    final class PathfinderFollowOwner extends PhantomMoveTargetGoal {
        ...
        private void selectNext() {
            ...
            BlockPos anchor = (BlockPos) Reflex.getFieldValue(PhantomPet.this, "cb");
            if (anchor == null) return;

            if (BlockPos.ZERO.equals(anchor)) {
                Reflex.setFieldValue(PhantomPet.this, "cb", new BlockPos(anchor = PhantomPet.this.blockPosition()));
            }
