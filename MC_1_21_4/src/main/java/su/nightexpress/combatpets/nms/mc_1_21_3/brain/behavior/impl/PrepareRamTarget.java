package su.nightexpress.combatpets.nms.mc_1_21_3.brain.behavior.impl;
...
import su.nightexpress.combatpets.nms.mc_1_21_3.pets.brained.GoatPet;
...
public class PrepareRamTarget<E extends PathfinderMob> extends Behavior<E> {
    ...
    protected void start(ServerLevel worldserver, PathfinderMob pet, long i) {
        PetAI.getAngerTarget(pet).ifPresent((target) -> {
