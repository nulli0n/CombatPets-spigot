...
public class EvokerPet extends Evoker implements PetEntity {
    ...
    static {
        Class<?> classAttackSpellGoal = Reflex.getInnerClass(Evoker.class.getName(), "EvokerAttackSpellGoal"); // a
        Class<?> clasCastSpellGoal = Reflex.getInnerClass(Evoker.class.getName(), "EvokerCastingSpellGoal"); // b
