...
public class PhantomPet extends Phantom implements PetEntity {
    ...
    static {
        Class<?> CLASS_I = Reflex.getInnerClass(Phantom.class.getName(), "i");
        Class<?> CLASS_C = Reflex.getInnerClass(Phantom.class.getName(), "c");
    ...
    abstract class PhantomMoveTargetGoal extends Goal {
        ...
        protected boolean touchingTarget() {
            Vec3 moveTargetPoint = (Vec3) Reflex.getFieldValue(PhantomPet.this, "e");
        ...
        protected Object getAttackPhase() {
            return Reflex.getFieldValue(PhantomPet.this, "bT"); // Get attack phase
            // 0 - CIRCLE
            // 1 - SWOOP
        }

        protected void setAttackPhase(int i) {
            Reflex.setFieldValue(PhantomPet.this, "bT", phaseValues[i]);
        }
    }
    ...
    final class PathfinderFollowOwner extends PhantomMoveTargetGoal {
        ...
        private void selectNext() {
            ...
            BlockPos anchor = (BlockPos) Reflex.getFieldValue(PhantomPet.this, "bS");
            if (anchor == null) return;

            if (BlockPos.ZERO.equals(anchor)) {
                Reflex.setFieldValue(PhantomPet.this, "bS", new BlockPos(anchor = PhantomPet.this.blockPosition()));
            }
            ...
            Reflex.setFieldValue(PhantomPet.this, "e", point);
        }
    }
}
