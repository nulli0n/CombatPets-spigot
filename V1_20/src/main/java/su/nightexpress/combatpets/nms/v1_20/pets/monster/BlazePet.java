...
import su.nightexpress.combatpets.nms.v1_20.goals.combat.AbstractPetAttackGoal;
...
public class BlazePet extends Blaze implements PetEntity {
    ...
    static {
        SET_CHARGED = Reflex.getMethod(Blaze.class, "w", Boolean.TYPE);
    }
    ...
    static class PathfinderGoalBlazeFireball extends AbstractPetAttackGoal {
